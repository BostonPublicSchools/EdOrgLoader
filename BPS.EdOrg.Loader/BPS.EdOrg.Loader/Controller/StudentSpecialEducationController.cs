...
namespace BPS.EdOrg.Loader.Controller
{
    class StudentSpecialEducationController
    {
        ...
        /// <summary>
        /// Insert/Updatethe alert data in edfi.StudentSpecialEducation
        /// </summary>
        /// <returns></returns>
        public void UpdateAlertSpecialEducationData(string token, ParseXmls prseXMl)
        {
            try
            {                
                XmlDocument xmlDoc = prseXMl.ToXmlDocument(XDocument.Parse(GetModifiedXml()));
                XmlNodeList nodeList = xmlDoc.SelectNodes("//roots/root");               
                foreach (XmlNode node in nodeList)
                {
                    // Fetching data per node
        ...
        /// <summary>
        /// Modifying the PCG generated xml
        /// </summary>
        /// <returns></returns>
        private static string GetModifiedXml()
        {
            // Xml generated by PCG is not in correct format modifying the file to add root and modify elements.
        ...
        /// <summary>
        /// Verify 504 Program data in edfi.Program
        /// We cannot insert new data if related program doesn't exist
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Insert 504 Alert data generated from PCG file 
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Gets the success code of generated response
        /// </summary>
        /// <returns></returns>
        ...
        private static bool PostServiceDescriptor(string Item, string token)
        {
            ...
            IRestResponse response = null;
            //Generating the client for Service Descriptor
